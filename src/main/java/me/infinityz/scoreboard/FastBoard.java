...
public class FastBoard {
    ...
    public static final Method PLAYER_GET_HANDLE;
    ...
    private static final Constructor<?> PACKET_PLAY_INFO;

    // Scoreboard enums
    private static final Class<?> ENUM_SB_HEALTH_DISPLAY;
    private static final Class<?> ENUM_SB_ACTION;
    private static final Class<?> ENUM_PLAY_INFO;
    private static final Object ENUM_SB_HEALTH_DISPLAY_INTEGER;
    private static final Object ENUM_SB_ACTION_CHANGE;
    private static final Object ENUM_SB_ACTION_REMOVE;
    private static final Object ENUM_PLAY_ADD;
    private static final Object ENUM_PLAY_REMOVE;
    ...
    static {
        try {
            ...
            PACKET_PLAY_INFO = FastReflection.nmsClass("PacketPlayOutPlayerInfo").getConstructor();
            ...
            if (VersionType.V1_8.isHigherOrEqual()) {
                ...
                if (VersionType.V1_13.isHigherOrEqual()) {
                    ...
                    ENUM_PLAY_INFO = FastReflection.nmsClass("PacketPlayOutPlayerInfo$EnumPlayerInfoAction");
                } else {
                ...
                ENUM_PLAY_ADD = FastReflection.enumValueOf(ENUM_PLAY_INFO, "ADD_PLAYER");
                ENUM_PLAY_REMOVE = FastReflection.enumValueOf(ENUM_PLAY_INFO, "REMOVE_PLAYER");
            } else {
    ...
    public void addOrRemovePlayerFromTeam(String player, String team, int mode) throws Exception {
        Object packet = PACKET_SB_TEAM.newInstance();

        FIELDSET(packet, "a", team);
        FIELDSET(packet, "h", mode);

        try {
            Field f = packet.getClass().getDeclaredField("g");
            f.setAccessible(true);
            ((List<String>) f.get(packet)).add(player);
    ...
    public static void FIELDSET(final Object edit, final String fieldName, final Object value) {
        try {
    ...
    public void createTeam(String team, String prefix, String suffix) throws Exception {
        Object packet = PACKET_SB_TEAM.newInstance();
        FIELDSET(packet, "a", team);
        FIELDSET(packet, "h", 0);
        FIELDSET(packet, "b", "");
        FIELDSET(packet, "c", ChatColor.translateAlternateColorCodes('&', prefix));
        FIELDSET(packet, "d", ChatColor.translateAlternateColorCodes('&', "&r"));
        FIELDSET(packet, "i", 0);
        FIELDSET(packet, "e", "always");
        FIELDSET(packet, "f", 0);
        sendPacket(packet);
    }

    public void updatePlayerOrder(Player pl) throws ReflectiveOperationException {
        sendPacket(new PacketPlayOutPlayerInfo(EnumPlayerInfoAction.REMOVE_PLAYER, ((CraftPlayer) pl).getHandle()));
        // sendPacket(new PacketPlayOutPlayerInfo(EnumPlayerInfoAction.ADD_PLAYER,
